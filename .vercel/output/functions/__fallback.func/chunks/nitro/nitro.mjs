...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/wenyiqing/Desktop/test-nuxt-content/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _fHOvI9 = eventHandler(async (event) => {
...
const checksumsStructure = {
  "content": "6ug266GzaTeFGnQSirCCyvsDtQl3Mcw3HPzUDOEg25o"
};
...
const _ivoqxu = eventHandler(async (event) => {
...
const _lazy_KlaX6t = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_KlaX6t, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/sql_dump.txt', handler: _fHOvI9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _fHOvI9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/content/query', handler: _ivoqxu, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _ivoqxu, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_KlaX6t, lazy: true, middleware: false, method: undefined }
];
